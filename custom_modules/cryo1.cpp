...
//	std::vector<int> connected_cells(1000, 0);
	std::vector<double> connected_cells(1000, 0);
...
//	oocyte_cell.custom_data.add_int_vector("connections", connected_cells);
	oocyte_cell.custom_data.add_vector_variable("connections", connected_cells);
...
//	std::vector<int> connected_TZP(1000, 0);
	std::vector<double> connected_TZP(1000, 0);
...
//	oocyte_cell.custom_data.add_int_vector("TZP_status", connected_TZP);
	oocyte_cell.custom_data.add_vector_variable("TZP_status", connected_TZP);
...
//	oocyte_Ps_idx = oocyte_cell.custom_data.add_vector_variable("Ps", Ps_Vector);
	oocyte_cell.custom_data.add_vector_variable("Ps_vec", Ps_Vector);  //rwh: change name, append "_vec"

	std::vector<double> CPA_fluxes(4, 0.0);
	oocyte_cell.custom_data.add_vector_variable("CPA_fluxes", CPA_fluxes);

	std::vector<double> Inter_CPA_moles(4, 0.0);
	oocyte_cell.custom_data.add_vector_variable("Inter_CPA_moles", Inter_CPA_moles);
	...
	oocyte_cell.custom_data.add_vector_variable("Ext_CPA_concentration", Ext_CPA_concentration);

	std::vector<double> Prev_Inter_CPA_moles(4, 0.0);
	oocyte_cell.custom_data.add_vector_variable("Prev_Inter_CPA_moles", Prev_Inter_CPA_moles);
...
//	gran_cell.custom_data.add_vector_variable("connections", connected_cells);

//	std::vector<double> my_connected_cells(4, 0.0);
//	gran_cell.custom_data.add_vector_variable("connections", "dimensionless", {0.,1.,2.,42.} );
//	gran_cell.custom_data.add_vector_variable("connections", "dimensionless", {0.,1.,2.,42.} );
//	gran_cell.custom_data.add_vector_variable("connections", "dimensionless", my_connected_cells);
//    std::cout << gran_cell.custom_data << std::endl;
...
//	gran_cell.custom_data.add_int_vector("TZP_status", connected_TZP);
	gran_cell.custom_data.add_vector_variable("TZP_status", connected_TZP);
	// set custom data values
...
//	gran_Ps_idx = gran_cell.custom_data.add_vector_variable("Ps", Ps_Vector);
	gran_cell.custom_data.add_vector_variable("Ps_vec", Ps_Vector);  //rwh: change name "Ps" --> "Ps_vec"

	std::vector<double> CPA_fluxes(4, 0.0);
//	gran_CPA_fluxes_idx = gran_cell.custom_data.add_vector_variable("CPA_fluxes", CPA_fluxes);
	gran_cell.custom_data.add_vector_variable("CPA_fluxes", CPA_fluxes);

	std::vector<double> Inter_CPA_moles(4, 0.0);
	gran_cell.custom_data.add_vector_variable("Inter_CPA_moles", Inter_CPA_moles);

	std::vector<double> Ext_CPA_concentration(4, 0.0);
	gran_cell.custom_data.add_vector_variable("Ext_CPA_concentration", Ext_CPA_concentration);

	std::vector<double> Prev_Inter_CPA_moles(4, 0.0);
	gran_cell.custom_data.add_vector_variable("Prev_Inter_CPA_moles", Prev_Inter_CPA_moles);
...
//	transport_idx = cell_defaults.custom_data.add_vector_variable("transport", wsvalues);
	cell_defaults.custom_data.add_vector_variable("transport", wsvalues);
...
{
    static double foll_radius = 100;
    static double gran_radius = 10;
    static double oocyte_radius = 25;
    static double zona_radius = oocyte_radius;
    //place oocyte
    ...
    pC->assign_position(1, 1, 1); //oocyte position
    pC->set_total_volume(pC->custom_data["Initial volume"]); //sets initial total volume

    std::cout << "\t wolf one " << std::endl;
    ...
    int n = 0;
      ...
      std::cout << "\t wolf three " << std::endl;

    //make sphere
    double cell_radius=gran_radius;
    double sphere_radius=foll_radius;
    ...
    for(double z=-sphere_radius;z<sphere_radius;z+=z_spacing, zc++)
    {
        for(double x=-sphere_radius;x<sphere_radius;x+=x_spacing, xc++)
        {
            for(double y=-sphere_radius;y<sphere_radius;y+=y_spacing, yc++)
            {
                ...
                //std::cout << "tempPoint[0] " <<tempPoint[0]<< std::endl;
                //std::cout << "tempPoint[1] " <<tempPoint[1]<< std::endl;
                //std::cout << "tempPoint[2] " <<tempPoint[2]<< std::endl;

                if(sqrt(norm_squared(tempPoint))< sphere_radius)//within sphere (=100)
                {
                    if(sqrt(norm_squared(tempPoint))> zona_radius)//outside of antrum (=25)
                    {
                        //std::cout <<"sqrt(norm_squared(tempPoint): " <<sqrt(norm_squared(tempPoint))<< std::endl;
                        //std::cout << "tempPoint[0] " <<tempPoint[0]<< std::endl;
                        std::cout << "tempPoint= " <<tempPoint<< std::endl;
                        //std::cout << "tempPoint[1] " <<tempPoint[1]<< std::endl;
                        //std::cout << "tempPoint[2] " <<tempPoint[2]<< std::endl;
                        pCell=create_cell(gran_cell);
...
//    for (int i=0; i<(*all_cells).size(); i++)
   for (int i=0; i<5; i++)
   {
       for(int j=0; j<3; j++)
       {
           std::cout << "cell positions: " <<(*all_cells)[i]->position[j]<< std::endl;
       }
   }
...
//        pCell_1->custom_data["connections"][pCell_1->ID] = pCell_2->ID;
//        (pCell_1->custom_data["connections"])[0] = pCell_2->ID;
//        pCell_2->custom_data["connections"][pCell_2->ID] = pCell_1->ID;  
    }
    return;
}
...
{
    std::cout << "setup_microenvironment: 1\n";
...
//    microenvironment.decay_rates[1] = 0;
    ...
    std::cout << "setup_microenvironment: 2\n";
...
//    default_microenvironment_options.Dirichlet_condition_vector[2] = 0;
    ...
    std::cout << "setup_microenvironment: 3\n";
    initialize_microenvironment();
    std::cout << "setup_microenvironment: 4\n";
